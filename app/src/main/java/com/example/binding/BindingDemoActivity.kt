...
class BindingDemoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 和传统方式相比，这里不需要再自己写 findViewById 一个个拿控件。
        ...
        // 和传统方式最大的区别在这里：我们不是手动给每个 TextView 赋值，
        // 而是把“数据对象”交给 XML，让 XML 自己决定如何展示这些数据。
        ...
        binding.btnChangeData.setOnClickListener {
            // DataBinding 的关键优势：
            // 我们这里只修改数据模型本身，并没有像传统方式那样再去手动调用某个 updateUserInfo()。
            // 由于 XML 已经和 userItem 建立了绑定关系，所以数据一变，相关 TextView 会自动刷新。
